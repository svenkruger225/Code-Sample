...
class AdminController extends AuthorizedController {
	...
	public function __construct()
	{
		...
		//for exceptions (white list) visit config/auth.php and add theGroup anf allowed routes
	}
	...
	protected function ValidationErrorsToList(array $array) 
	{ 
		$return = "<ul>"; 
		array_walk_recursive($array, function($a) use (&$return) { $return .= "<li>$a</li>"; }); 
		return $return . "</ul>"; 
	}
