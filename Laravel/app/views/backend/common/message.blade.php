    <div class="modal hide modal-payment" id="single-message-form">
	    <div class="modal-header alert-info">
		    <a class="close" data-dismiss="modal">x</a>
		    <h3>Messaging Form</h3>
	    </div>
        <div class="modal-body-payment form-horizontal table-condensed" data-bind="with: selectedMessage">
		        <div class="tab-pane" id="Messaging">  
		            ...
		            <div class="control-group control-group-small">
		                <div class="controls pull-right">
							<button class="btn btn-primary" data-bind="click: submitBulkMessagesCmd"><i class="icon-white icon-thumbs-up"></i> Submit</button>
						</div>
		            </div>
                </div>
        </div>
