...
<div style="width: 100%; text-align:center; border:1px solid grey; padding-left:20px;">
	...
	<div>&nbsp;</div>
	<div><h2>Certificate of Attendance</h2></div>
	<div>&nbsp;</div>
	...
	<div><p>To authenticate this Certificate email <a href="mailto:info@coffeeschool.com.au">info@coffeeschool.com.au</a></p></div>
</div>
</body>
</html>
