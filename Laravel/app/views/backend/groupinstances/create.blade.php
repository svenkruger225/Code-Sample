...
<div class="page-header">
	<h3>
		...
		<div class="pull-right">
			<a href="{{ route('backend.instances.index', array('lid'=>Input::old('lid'),'cid'=>Input::old('cid'),'from'=>Input::old('from'),'to'=>Input::old('to'))) }}" class="btn btn-small btn-inverse"><i class="icon-circle-arrow-left icon-white"></i> Back</a>
		</div>
	</h3>
</div>
	...
	<div class="tab-content">
		...
		<div class="tab-pane active" id="tab-general">
			...
			<div class="control-group {{ $errors->has('location_id') ? 'error' : '' }}">
				...
				<div class="controls">
					{{ Form::select('location_id', $locations, Input::old('lid'), array('class'=>'input-xlarge')) }}				
			...
			<div class="control-group {{ $errors->has('instructor_id') ? 'error' : '' }}">
				...
				<div class="controls">
					{{ Form::select('instructor[]', $instructors, array(''), array('multiple', 'class'=>'input-xlarge')) }}				
			...
			<div class="control-group {{ $errors->has('course_date') ? 'error' : '' }}">
				...
				<div class="controls">
					{{ Form::text('course_date', Input::old('course_date'), array('class'=>'input-medium')) }}
			...
			<div class="control-group {{ $errors->has('time_start') ? 'error' : '' }}">
				...
				<div class="controls">
					{{ Form::text('time_start', Input::old('time_start'), array('class'=>'input-medium')) }}
			...
			<div class="control-group {{ $errors->has('time_end') ? 'error' : '' }}">
				...
				<div class="controls">
					{{ Form::text('time_end', Input::old('time_end'), array('class'=>'input-small')) }}
