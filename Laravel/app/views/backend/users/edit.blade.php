...
<div class="page-header">
	<h3>
		...
		<div class="pull-right">
			<a href="{{ route('backend.users.index') }}" class="btn btn-small btn-inverse"><i class="icon-circle-arrow-left icon-white"></i> Back</a>
		</div>
	</h3>
</div>
...
{{ Form::open(array('route' => array('backend.users.update', $user->id), 'method' => 'put',  'class'=>'form-horizontal')) }}
	...
	<div class="tab-content">
		...
		<div class="tab-pane active" id="tab-general">
			...
			<div class="control-group {{ $errors->has('mobile') ? 'error' : '' }}">
				...
				<div class="controls">
					<input type="text" name="mobile" id="mobile" value="{{ Input::old('mobile', $user->mobile) }}" />
	...
	<div class="control-group">
		<div class="controls">
			<a class="btn btn-link" href="{{ route('backend.users.index') }}">Cancel</a>
