...
<div class="page-header">
	<h3>
		...
		<div class="pull-right">
			<a href="{{ route('backend.groups.index') }}" class="btn btn-small btn-inverse"><i class="icon-circle-arrow-left icon-white"></i> Back</a>
		</div>
	</h3>
</div>
...
{{ Form::open(array('route' => array('backend.groups.update', $group->id), 'method' => 'put',  'class'=>'form-horizontal')) }}
	...
	<div class="control-group">
		<div class="controls">
			<a class="btn btn-small btn-link" href="{{ route('backend.groups.index') }}">Cancel</a>

			<button type="reset" class="btn">Reset</button>

			<button type="submit" class="btn btn-small btn-success">Update Group</button>
		</div>
	</div>
