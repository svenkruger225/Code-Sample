...
{{ Form::open(array('route' => 'backend.courses.store', 'class'=>'form-horizontal')) }}
	...
	<div class="tab-content">
		...
		<div class="tab-pane active" id="tab-general">
			...
			<div class="control-group {{ $errors->has('type') ? 'error' : '' }}">
				...
				<div class="controls">
					{{ Form::select('type', array('FaceToFace'=> 'Face to Face', 'Online'=> 'Online'), Input::old('type'), array('class'=>'input-medium')) }}
			...
			<div class="control-group {{ $errors->has('assessment_type') ? 'error' : '' }}">
				...
				<div class="controls">
					{{ Form::select('assessment_type', array('FaceToFace'=> 'Face to Face', 'Review'=> 'Review', 'Online'=> 'Online'), Input::old('assessment_type'), array('class'=>'input-medium')) }}
			...
			<div class="control-group {{ $errors->has('description') ? 'error' : '' }}">
				...
				<div class="controls">
					{{ Form::textarea('description', Input::old('description'), array('class'=>'span8', 'rows'=>'3')) }}
			...
			<div class="control-group {{ $errors->has('rto_code') ? 'error' : '' }}">
				...
				<div class="controls">
					{{ Form::text('rto_code', Input::old('rto_code'), array('class'=>'input-medium')) }}
			...
			<div class="control-group {{ $errors->has('certificate_code') ? 'error' : '' }}">
				...
				<div class="controls">
					{{ Form::text('certificate_code', Input::old('certificate_code'), array('class'=>'input-xxlarge')) }}
					...
					<table class="table table-striped table-bordered table-condensed table-hover courses">
						...
						<tbody id="courses_list">
							<tr class="template" style="display:none;">
								<td>{{ Form::select('location_id[]', $locations, '', array('class'=>'input-medium')) }}</td>
							...
							<tr>
								<td>{{ Form::select('location_id[]', $locations, $id, array('class'=>'input-medium')) }}</td>
								<td><input type="text" name="price_online[]" class="input-mini price id" /></td>
								<td><input type="text" name="price_offline[]" class="input-mini price" /></td>
								<td><input type="text" name="discount[]" class="input-mini percentage" /></td>
								<td>{{ Form::select('discount_type[]', array('0'=> 'Percentage', '1'=> 'Amount'), '0', array('class'=>'input-small')) }}</td>
			...
			<div class="control-group {{ $errors->has('myob_code') ? 'error' : '' }}">
				...
				<div class="controls">
					{{ Form::text('myob_code', Input::old('myob_code'), array('class'=>'input-small')) }}
			...
			<div class="control-group {{ $errors->has('pair_course_id') ? 'error' : '' }}">
				...
				<div class="controls">
					{{ Form::select('pair_course_id', $courses, Input::old('pair_course_id'), array('class'=>'input-large')) }}				
			...
			<div class="control-group {{ $errors->has('pair_course_id_to_add') ? 'error' : '' }}">
				...
				<div class="controls">
					{{ Form::select('pair_course_id_to_add', $courses, Input::old('pair_to_add'), array('class'=>'input-large')) }}				
