...
<html lang="en">
<head>
    <title>RSA Course Melbourne Responsible Service of Alcohol Melbourne</title>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <link href="/_scripts/src/bower_modules/frontend/style.css" rel="stylesheet" type="text/css" />
    <link href="/_scripts/src/bower_modules/frontend/layout.css" rel="stylesheet" type="text/css" />
    ...
    <meta name="Keywords" content="RSA Course  Melbourne
Responsible Service of Alcohol
RSA Training
RSA Melbourne<br />
RSA Course Melbourne Responsible Service of Alcohol course Melbourne " />
...
<div id="main">
    ...
    <div id="header" style="height: auto !important;">
        <div class="block1">
            <div class="container">
                <div class="left">
                    <a href="http://rsamelbourne.com/index.html"><img alt="RSA Course Melbourne" src="http://rsamelbourne.com/images/menlbourne_logo.jpg" /></a><br />
                </div>
                <div class="right">
                    <a href="http://rsamelbourne.com/#"><img alt="RSA course Melbourne" src="http://rsamelbourne.com/images/s.gif" /></a><img alt="" src="http://rsamelbourne.com/images/nav-line.gif" /><a href="//rsamelbourne.com/index.html"><img alt="RSA Melbourne" src="http://rsamelbourne.com/images/h-act.gif" /></a><img alt="" src="http://rsamelbourne.com/images/nav-line.gif" /><a href="//rsamelbourne.com/contact.html"><img alt="RSA course Melbourne" src="http://rsamelbourne.com/images/c.gif" /></a><br />
                </div>
            </div>
        </div>
        <div class="menu">
            <ul>
                <li><a href="http://rsamelbourne.com/index.html">Home Page</a></li>
                <li><a href="http://rsamelbourne.com/RSA_Course_Melbourne.html">RSA Course</a></li>
                <li><a href="http://rsamelbourne.com/RCG_Course_Melbourne.html">RSG Course</a></li>
                <li><a href="http://rsamelbourne.com/RSA_RCG_Melbourne.html">RSA + RCG (RSG)</a></li>
                <li><a href="http://rsamelbourne.com/BaristaCourse_Melbourne.html">Barista Course</a></li>
                <li><a href="http://rsamelbourne.com/contact.html">Contact</a></li>
            </ul>
        </div>
    </div>
    <!--header end-->
    <div id="coffee-container" class="container-fluid">
        ...
        <!--footer -->
        <div id="footer">
            Auspcsupport&nbsp;&nbsp;<span>&copy; 2013<br />ABN 39 674276799	    &nbsp;</span><span>|&nbsp;</span> <a href="http://rsamelbourne.com/index-7.html">Privacy policy</a>
        </div>
        <!--footer end-->
