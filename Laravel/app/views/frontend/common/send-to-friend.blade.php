    <div class="modal hide" id="send-to-friend-modal">
        ...
        <div class="modal-body-payment form-horizontal">
		    ...
		    <div class="control-group"> 
		        <label class="control-label" for="friend_email">Friend's Email : *Required</label>
		        <div class="controls">
	    ...
	    <div class="modal-footer ">
	        <div class="control-group">
				<button class="btn btn-success" data-bind="click: submitEmail"><i class="icon-white icon-thumbs-up"></i> Submit Test</button>
	        </div>
	    </div>
    </div>
