...
<tr class="row">
	<td class="col-md-6">
		<span data-bind="html: $data.courseName"></span><br>
		<small><span data-bind="html: $data.courseDate.Display()"></span><br>
		<span data-bind="html: $data.courseAddress"></span></small>
	</td>
	<td class="col-md-3">
	...
	<td class="col-md-1">
		<button title="Remove Course" class="btn btn-danger btn-xs" data-bind="attr: { id: $data.courseInstance }, click: $root.removeInstance.bind($data, $data.courseInstance), disable: $data.isPaid() || $data.itemType() == 'OnlineCourse'"><i class="glyphicon glyphicon-remove"></i></button>
	</td>
</tr>
</script>
