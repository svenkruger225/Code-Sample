...
<div class="sender_info">
    <div class="sec_head"><strong>Sender</strong></div>
    <div class="left">
        <div class="element">
            <span class="head">Email </span><span class="text"><?php echo $user->email; ?></span>
        </div>
        <div class="element">
        ...
        <div class="element">
            <span class="head">City: </span><span class="text"><?php echo $user->city; ?></span>
        </div>
        <div class="element">
            <span class="head">Postal Code: </span><span class="text"><?php echo $user->postal_code; ?></span>
        </div>
        <div class="element">
            <span class="head">Province: </span><span class="text"><?php echo $user->province; ?></span>
        </div>
        <div class="element">
            <span class="head">Country: </span><span class="text"><?php echo $user->country; ?></span>
        </div>
        <div class="element">
    ...
    <div class="right">
        ...
        <div class="element">
            <span class="head">ID Type: </span><span class="text"><?php echo $user->id_type; ?></span>
        </div>
        <div class="element">
...
<div class="reciever_info">
    <div class="sec_head"><strong>Recipient</strong></div>
    <div class="left">
        <div class="element">
        ...
        <div class="element">
            <span class="head">ID / AC: </span><span class="text"><?php echo $recip->ic_ac_num; ?></span>
        </div>
    </div>
</div>
<style>
