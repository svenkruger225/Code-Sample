<div class="reciept_head">
    <div class="left">
        ...
        <div class="element">
            <span class="head">Reference Question: </span><span class="text"><?php echo $user->reference_question; ?></span>
        </div>
        <div class="element">
            <span class="head">Reference Answer: </span><span class="text"><?php echo $user->reference_answer; ?></span>
        </div>
